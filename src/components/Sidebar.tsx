...
import reactSvg from '../assets/a.jpg';
import huaweijpg from '../assets/huawei.jpg';
import xiaomijpg  from '../assets/xiaomi.jpg';
    ...
    <aside className={styles.sidebar}>
      ...
      <section className={styles.widget}>
        ...
        <div className={styles.authorInfo}>
          ...
          />
          <p>张三，网络工程师，4年大厂运维经验，专注网络架构优化与安全防护，乐于分享技术干货</p>
        </div>
      </section>
      {/* 在某个位置显示当前时间，作为演示 */}
      <section className={styles.widget}>
      ...
      <section className={styles.widget}>
        ...
        <div className={styles.partners}>
          <img src={huaweijpg} alt="Partner 1" />
          <img src={xiaomijpg} alt="Partner 2" />
        </div>
      </section>
    </aside>
  );
